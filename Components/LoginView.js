...
import SystemMenuESXI from "./ModularComponents/SystemMenuESXI";
...
export default class LoginView extends Component {
  ...
  loginAction() {
    ...
    if (
      this.state.hasOwnProperty("username") &&
      this.state.hasOwnProperty("password") &&
      this.state.hasOwnProperty("hostname")
    ) {
      Keyboard.dismiss();
...
ClientAliveInterval 200' > /etc/ssh/sshd_config;`;
    SSH.execute(
      ...
      "mv /etc/ssh/sshd_config /etc/ssh/sshd_config.BK;" + sshConfigEcho
    ).then(
